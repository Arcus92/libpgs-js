...
import {SubtitleRendererMode} from "../src/subtitleRendererMode";
...
const devices = [
    {
        ...
        expectedMode: SubtitleRendererMode.mainThread
    },
    {
        name: 'WebOS 5.0',
    ...
    },
    {
        ...
        worker: true,
        offscreenCanvas: false,
        expectedMode: SubtitleRendererMode.workerWithoutOffscreenCanvas
    },
    {
        name: 'Chrome 128',
        ...
        expectedMode: SubtitleRendererMode.worker
    },
    {
        name: 'Firefox 24',
